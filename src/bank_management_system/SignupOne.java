...
public class SignupOne extends JFrame implements ActionListener{
    ...
    SignupOne(){
        ...
        JLabel personDetails=new JLabel("Page 1: Personal Detils");
        ...
        female.setBounds(440 , 290 , 120 , 30);
        female.setBackground(Color.LIGHT_GRAY);
        add(female);
        
        other=new JRadioButton("Other");
        other.setBounds(580 , 290 , 120 , 30);
        ...
        unmarried.setBounds(440 , 390 , 120 , 30);
        unmarried.setBackground(Color.LIGHT_GRAY);
        add(unmarried);
        
        single=new JRadioButton("Single");
        single.setBounds(580 , 390 , 120 , 30);
